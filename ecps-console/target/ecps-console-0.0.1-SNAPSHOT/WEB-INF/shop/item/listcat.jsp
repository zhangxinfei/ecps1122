...
<div class="frameR"><div class="content">
    ...
    <a href="${path}/item/cat/listCat.do?catType=1"  title="实体商品" class="here">实体商品</a>
<%--     <a href="${path}/card/listCardCat.do?catType=2"  title="移动号卡" class="nor">移动号卡</a> --%>
    </span></h2>
    <form id="form1" name="form1" action="${path}/item/cat/listCat.do" method="post">
    <div class="page_c">
    	<span class="l">
    ...
    <c:url value="/${system }/item/cat/getCat.do?itemType=1" var="getCat"/>
	<c:url value="/${system }/item/feature/listFeature.do?itemType=1" var="listFeature"/>
