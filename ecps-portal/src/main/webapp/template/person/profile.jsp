			...
			<div class="ofc">
				...
				<form id="jvForm" action="profile.do" method="post">
					...
					<li>
						...
						<span class="word">tonglaiz</span>
					</li>
					<li>
						<label for="username">邮　　箱：</label>
						<span class="word">gerry.1012@live.cn</span>
					</li>
					<li>
						<label for="realName">真实姓名：</label>
						<span class="bg_text"><input type="text" id="realName" name="realName" maxLength="32" vld="{required:true}" /></span>
						<span class="pos"><span class="tip okTip">&nbsp;</span></span>
					</li>
					<li>
						<label for="gender">性　　别：</label>
						<span class="word"><input type="radio" name="gender" />保密<input type="radio" name="gender" />男<input type="radio" name="gender" />女</span>
					</li>
					<li>
					...
					<li><label for="address">详细地址：</label>
						<span class="bg_text"><input type="text" id="address" name="address" maxLength="32" vld="{required:true}" /></span>
